    ...
    <>
      ...
      >
        ...
        <motion.button
          whileTap={{
            backgroundColor:
              activeStep === 2 ? 'var(--color-primary)' : 'var(--color-surface-container-low)',
          }}
          onClick={() => {
            if (activeStep > 1) {
        ...
        <AnimatePresence mode="wait">
          {activeStep === 2 ? (
                ...
                {activeItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="pt-1 flex flex-col flex-1 text-xs min-w-0">
                      ...
                      <h4
                        className="font-bold text-[#1a1c1a] truncate leading-tight mt-0.5"
                        title={item.title}
                      >
                        {item.title}
                      </h4>
              ...
              <div className="pt-4 border-t border-[#f4f3f1] flex flex-col gap-4">
                <label className="flex items-start gap-2.5 text-xs select-none cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setSendUpdatesToWhatsApp(e.target.checked)}
                  ...
                  <span className="text-secondary leading-normal">
                    Send dispatch alerts and scaper live credentials to WhatsApp
                  </span>
                </label>
            ...
            >
              <span>{activeItems.length} handcrafted master decor selections configured.</span>
            </motion.div>
          )}
        </AnimatePresence>
      </motion.div>

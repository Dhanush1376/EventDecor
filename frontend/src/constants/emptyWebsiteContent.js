...
export const emptyWebsiteContent = {
  ...
  featuredCollections: { sectionTitle: '', sectionSubtitle: '', items: [], isVisible: true, status: 'published' },
  featuredProducts: { sectionTitle: '', sectionSubtitle: '', productIds: [], maxDisplay: 4, isVisible: true, status: 'published' },

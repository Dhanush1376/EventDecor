...
const mapDbOrderToFrontend = (o) => {
  ...
  return {
    id: orderIdStr,
    customer: o.customerName || o.shippingAddress?.name || o.user?.name || 'Store Customer',
    customerName: o.customerName || o.user?.name || o.shippingAddress?.name || '',
    customerEmail: o.customerEmail || o.user?.email || o.shippingAddress?.email || '',
    customerPhone: o.customerPhone || o.user?.phone || '',
    shippingPhone: o.shippingPhone || o.shippingAddress?.phone || '',
    codPhoneVerified: Boolean(o.codPhoneVerified),
    codVerifiedAt: o.codVerifiedAt || null,
    paymentDetails: o.paymentDetails || null,
    upiVpa: o.paymentDetails?.upiVpa || null,
    email: o.customerEmail || o.shippingAddress?.email || o.user?.email || 'customer@email.com',
    phone: o.shippingPhone || o.shippingAddress?.phone || o.customerPhone || o.user?.phone || '',
    items: mappedItems,

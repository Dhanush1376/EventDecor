...
export const initialWebsiteContent = {
  ...
  hero: {
    ...
    subtitle:"Luxury side-stage decorative presentations, custom ring trays, and artisan carved coconuts for traditional Telugu engagement ceremonies",
  ...
  seo: {
    ...
    globalDescription:"Premium handcrafted wedding, engagement, and ceremonial decorations rooted in South Indian heritage. Custom designs by master artisans in Ongole.",
    globalKeywords:"wedding decorations, Indian wedding, handcrafted decor, bridal entry, harathi plates, engagement trays, Ongole",
    ogImage: IMAGES.luxuryRoyalWedding,
    pages: {
      home: {
        title:"Siri Arts & Crafts — The Digital Studio",
        description:"Premium handcrafted event decorations for weddings, engagements, and sacred ceremonies.",
      },
      shop: {
      ...
      events: {
        ...
        description:"Complete event decoration services for weddings, engagements, and traditional ceremonies.",
      },
      about: {
        title:"Our Story — Siri Arts & Crafts",
        description:"Learn about our heritage, our artisans, and our mission to preserve traditional craftsmanship.",
      },
      contact: {

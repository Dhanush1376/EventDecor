    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 items-start">
        ...
        <div className="xl:col-span-2 flex flex-col gap-4 sm:gap-6">
            ...
            <div className="flex items-center justify-between overflow-x-auto py-2">
              {[1, 2, 3, 4, 5].map((s, i) => (
                <React.Fragment key={s}>
                  ...
                  {i < 4 && <AdminSkeleton className="flex-1 h-[2px] mx-2" />}
                </React.Fragment>
              ))}
            </div>
          </div>
          ...
          <div className="admin-card p-5 sm:p-6 rounded-[4px] border border-[var(--admin-border)] space-y-4">
            ...
            <div className="divide-y divide-[var(--admin-border-subtle)]">
              {[1, 2, 3].map((item) => (
                <div key={item} className="py-3.5 flex items-center justify-between gap-4">
                  ...
                  <div className="text-right space-y-1">
                    <AdminSkeleton className="w-16 h-4 rounded ml-auto" />
                    <AdminSkeleton className="w-12 h-3 rounded ml-auto" />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="xl:col-span-1 flex flex-col gap-4 sm:gap-6 sticky top-[88px]">
          ...
          <div className="admin-card p-5 rounded-[4px] border border-[var(--admin-border)] space-y-3">

      ...
      {selectedOrder && (
        <>
          ...
          <motion.div
            ...
            className={
              isMobile
                ? 'fixed bottom-0 left-0 right-0 max-h-[92%] h-full w-full bg-[var(--admin-surface)] z-50 shadow-2xl flex flex-col rounded-t-[var(--admin-radius-2xl)] border-t border-[var(--admin-border)]'

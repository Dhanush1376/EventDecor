...
export function StatusBadge({ status, className = '' }) {
  const cfg = {
    ...
    team_assigned: 'admin-badge-info',
    packing: 'admin-badge-info',
    dispatch: 'admin-badge-info',
    installation: 'admin-badge-info',
    event_day: 'admin-badge-success',
    modified: 'admin-badge-neutral',
    processing: 'admin-badge-info',
    shipped: 'admin-badge-info',
    pending: 'admin-badge-warning',
    pending_payment: 'admin-badge-warning',
    pendingpayment: 'admin-badge-warning',

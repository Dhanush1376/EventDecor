  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed sm:right-0 sm:top-0 top-[10dvh] inset-x-0 sm:inset-x-auto h-[90dvh] sm:h-[100dvh] w-full sm:w-[500px] z-[1000] shadow-[var(--admin-shadow-2xl)] flex flex-col overflow-hidden border-t sm:border-t-0 sm:border-l border-[var(--admin-border)] rounded-t-2xl sm:rounded-none"

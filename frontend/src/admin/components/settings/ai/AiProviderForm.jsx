      ...
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full animate-fade-in-up flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3 bg-gray-50 rounded-b-xl">
          ...
          <button
            ...
            disabled={saving}
            className="h-9 px-4 text-[12px] font-bold text-white bg-[var(--admin-accent)] rounded-[4px] hover:opacity-95 disabled:opacity-50 flex items-center gap-1.5 shadow-xs cursor-pointer transition-all"
          >
            {saving ? (
              <>

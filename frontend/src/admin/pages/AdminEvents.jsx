...
const EVENT_CATEGORIES = ["Wedding Ceremony","Engagement Ceremony","House Warming Ceremony","Baby Shower Ceremony","Naming Ceremony","Festival Decorations",
];
    ...
    <div className="max-w-[1300px] mx-auto space-y-6 pb-20 font-body text-on-surface">
      ...
      <div className="flex flex-wrap items-center justify-between border-b border-black/5 pb-4 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-1.5 bg-stone-100 p-1 rounded-full text-[11px]">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-2 rounded-full font-medium tracking-wide uppercase text-[11px] sm:text-[11px] sm:text-[11px] tracking-wider font-bold transition-all cursor-pointer ${
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-black hover:bg-stone-900 text-white px-5 py-2.5 rounded-full font-medium tracking-wide uppercase text-[11px] sm:text-[11px] sm:text-[11px] tracking-wider font-bold shadow-md hover:shadow-lg transition-all cursor-pointer"
          >
      ...
      <AnimatePresence mode="wait">
          ...
          <motion.div key="dashboard" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-2xl border border-black/5 p-5 shadow-sm space-y-1">
                <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black/40 block">Total Bookings Value</span>
                <span className="text-[11px] font-bold text-black not-italic">₹{totalContractVal.toLocaleString("en-IN")}</span>
                <span className="text-[11px] text-emerald-600 font-semibold block">Active bookings</span>
              </div>
              <div className="bg-white rounded-2xl border border-black/5 p-5 shadow-sm space-y-1">
                <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black/40 block">Pending Payments</span>
                <span className="text-[11px] font-bold text-black not-italic">₹{outstandingBal.toLocaleString("en-IN")}</span>
                <span className="text-[11px] text-orange-600 font-semibold block">Payments to collect</span>
              </div>
              <div className="bg-white rounded-2xl border border-black/5 p-5 shadow-sm space-y-1">
                <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black/40 block">Setups Happening Today</span>
                <span className="text-[11px] font-bold text-black not-italic">{activeBookingsCount} Setups</span>
                <span className="text-[11px] text-stone-600 font-semibold block">Active events</span>
              </div>
              <div className="bg-white rounded-2xl border border-black/5 p-5 shadow-sm space-y-1">
                <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black/40 block">Upcoming Event Setups</span>
                <span className="text-[11px] font-bold text-black not-italic">{upcomingSetupsCount} Runs</span>
                <span className="text-[11px] text-stone-600 font-semibold block">Scheduled events</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-3xl border border-black/5 p-6 shadow-sm space-y-4">
                <div className="flex justify-between items-center border-b border-black/5 pb-2">
                  <h3 className="text-[11px] text-black font-bold">New Event Inquiries</h3>
                  <button onClick={() => setActiveTab("bookings")} className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black font-bold">View All Bookings →</button>
                </div>
                  ...
                  {bookings.slice(0, 4).map((b) => (
                    ...
                    >
                      <div className="space-y-1 min-w-0 flex-1 pr-4">
                        <span className="bg-slate-100 text-black px-2 py-0.5 rounded-full font-medium tracking-wide text-[7px] uppercase tracking-widest font-bold">{b.eventType}</span>
                        <h4 className="text-[11px] text-black font-bold truncate mt-1">{b.title}</h4>
                        <p className="font-mono text-[11px] sm:text-[11px] sm:text-[11px] text-black/35 truncate">{b.venue?.address}</p>
                      </div>
                      <div className="text-right shrink-0">
                        <span className="text-[11px] text-black font-bold block">₹{b.pricing?.totalPrice?.toLocaleString("en-IN")}</span>
                        <span className="text-[11px] sm:text-[11px] sm:text-[11px] text-black capitalize font-semibold">{b.status.replace("_","")}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-3xl border border-black/5 p-6 shadow-sm space-y-4">
                <h3 className="text-[11px] text-black font-bold border-b border-black/5 pb-2">Occasion Category Distributions</h3>
          ...
          <motion.div key="bookings" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="bg-white rounded-3xl border border-black/5 shadow-sm overflow-hidden">
              <div className="p-5 border-b border-black/5 flex justify-between items-center bg-stone-50">
                <h3 className="text-[11px] text-black font-bold">Interactive Booking List</h3>
                <span className="bg-stone-200 text-stone-700 px-3 py-1 rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold">
              ...
              {loadingBookings ? (
                ...
                <div className="py-20 text-center text-outline text-[11px]">No active custom bookings logged.</div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-[11px] border-collapse">
                    <thead>
                      <tr className="bg-stone-100 text-outline uppercase tracking-wider font-medium tracking-wide text-[11px] font-bold border-b border-black/5">
                        ...
                        <tr key={b._id || b.id} className="hover:bg-stone-50/50 transition-colors">
                          <td className="p-4">
                            <div className="space-y-0.5">
                              <span className="font-body text-[11px] text-black font-bold block">{b.user?.name ||"Anonymous Client"}</span>
                              <span className="font-mono text-[11px] text-black/40 block">{b.user?.phone ||"No contact"}</span>
                            </div>
                          </td>
                          <td className="p-4">
                            <div className="space-y-1">
                              <span className="bg-slate-100 text-black px-2 py-0.5 rounded-full font-medium tracking-wide text-[7px] uppercase tracking-widest font-bold">{b.eventType}</span>
                              <h4 className="text-[11px] text-black font-bold mt-1 truncate max-w-[150px]">{b.title}</h4>
                            </div>
                          </td>
                          <td className="p-4">
                            <div className="space-y-0.5">
                              <span className="font-body text-[11px] sm:text-[11px] text-black font-semibold block">
                                {new Date(b.date).toLocaleDateString("en-IN", { month:"short", day:"numeric", year:"numeric" })}
                              </span>
                              <span className="font-body text-[11px] text-black/40 truncate max-w-[180px] block">{b.venue?.address}</span>
                            </div>
                          </td>
                          <td className="p-4">
                            <div className="space-y-0.5">
                              <span className="text-[11px] text-black font-bold block">₹{b.pricing?.totalPrice?.toLocaleString("en-IN")}</span>
                              <span className={`text-[11px] font-bold uppercase tracking-widest ${b.pricing?.paymentStatus ==="paid" ?"text-green-600" :"text-amber-600"}`}>
                                {b.pricing?.paymentStatus}
                              </span>
                            </div>
                          </td>
                          <td className="p-4">
                            <span className="font-body text-[11px] text-black capitalize font-bold">{b.status.replace("_","")}</span>
                          </td>
                          <td className="p-4 text-center">
                            <button
                              onClick={() => { setSelectedBooking(b); setIsDrawerOpen(true); }}
                              className="px-4 py-2 bg-stone-900 text-white rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold hover:bg-black hover:text-black transition-colors"
                            >
                              Manage Booking
                            </button>
                          </td>
          ...
          <motion.div key="calendar" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="bg-white rounded-3xl border border-black/5 shadow-sm p-6 space-y-6">
              <div className="flex justify-between items-center border-b border-black/5 pb-3">
                <div className="space-y-0.5">
                  <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black font-bold">MONTHLY EVENT SCHEDULE</span>
                  <h3 className="text-[11px] text-black font-bold">{currentMonthName}</h3>
                </div>
                <div className="flex gap-4 text-[11px] sm:text-[11px] sm:text-[11px] font-bold font-medium tracking-wide uppercase tracking-widest text-black/50">
              ...
              <div className="grid grid-cols-7 gap-2 text-center text-[11px]">
                {["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map((day) => (
                  <div key={day} className="py-2 font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/45 font-bold bg-stone-50 border border-black/5 rounded-lg">{day}</div>
                ))}
                ...
                {calendarDays.map((cell, idx) => {
                  ...
                  return (
                    ...
                    >
                      {cell.day && <span className="font-semibold text-black/40">{cell.day}</span>}
                        ...
                        <div className="space-y-1">
                          {dayBookings.map((b) => (
                            <div
                              key={b._id}
                              onClick={() => { setSelectedBooking(b); setIsDrawerOpen(true); }}
                              className={`p-1 text-[11px] leading-tight font-bold rounded text-white truncate cursor-pointer ${
        ...
        {activeTab ==="packages" && (
          <motion.div key="packages" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-[11px] text-black font-bold">Decor Packages & Themes</h3>
                <p className="text-[11px] text-outline">Manage published catalogs visible to customer discovery masonry grids.</p>
              </div>
              <button
                onClick={() => {
                ...
                className="px-6 py-2.5 bg-black text-white rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold shadow-lg hover:shadow-slate-950/5 transition-all flex items-center gap-1.5 cursor-pointer"
              >
                ...
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height:"auto" }} exit={{ opacity: 0, height: 0 }} className="bg-white rounded-2xl border border-black/5 p-6 shadow-xl overflow-hidden">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Theme Title *</label>
                        <input type="text" value={formData.title} onChange={(e) => setFormData({ ...formData, title: e.target.value })} placeholder="Royal Mysore Mandap" className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" required />
                      </div>
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Subtitle</label>
                        <input type="text" value={formData.subtitle} onChange={(e) => setFormData({ ...formData, subtitle: e.target.value })} placeholder="Twilight Sanctuary" className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" />
                      </div>
                      <div className="space-y-1">
                        <div className="flex items-center justify-between">
                          <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Category *</label>
                          <button
                            type="button"
                        ...
                        <select value={formData.category} onChange={(e) => setFormData({ ...formData, category: e.target.value })} className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" required>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Decor Style *</label>
                        <select value={formData.style} onChange={(e) => setFormData({ ...formData, style: e.target.value })} className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" required>
                          <option value="">Select Style</option>
                          {DECOR_STYLES.map(s => <option key={s} value={s}>{s}</option>)}
                        </select>
                      </div>
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Pricing Tag</label>
                        <input type="text" value={formData.pricing} onChange={(e) => setFormData({ ...formData, pricing: e.target.value })} placeholder="Starts at ₹75,000" className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" />
                      </div>
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Venue Footprint Cover</label>
                        <input type="text" value={formData.venueSize} onChange={(e) => setFormData({ ...formData, venueSize: e.target.value })} placeholder="e.g. Heritage Lawns / Grand Ballroom" className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" />
                      </div>
                      <div className="space-y-1">
                        <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">completed count</label>
                        <input type="text" value={formData.decorCount} onChange={(e) => setFormData({ ...formData, decorCount: e.target.value })} placeholder="40+ Completed" className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none" />
                      </div>
                    </div>

                    <div className="space-y-1">
                      <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Atmospheric Narrative (Description) *</label>
                      <textarea rows={3} value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} placeholder="Narrate details..." className="w-full bg-[#F8F9FB] px-4 py-3 rounded-2xl border border-black/5 text-[11px] focus:border-slate-900 outline-none resize-none" required />
                    </div>

                    {/* SEO Meta Configuration */}
                    <div className="border-t border-black/5 pt-4 space-y-4">
                      <div>
                        <h4 className="text-[11px] text-black font-bold flex items-center gap-1.5">
                          <span className="material-symbols-outlined text-[15px] text-slate-800">language</span>
                          SEO Meta Configuration (Siri Arts & Crafts)
                        </h4>
                        <p className="text-[11px] text-black/40 mt-0.5">Configure custom search engine tags to optimize the discovery of this event setup.</p>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">
                            SEO Meta Title
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none"
                          />
                          <div className="flex justify-between items-center px-1 text-[11px] sm:text-[11px] sm:text-[11px] text-black/45">
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            className="w-full bg-[#F8F9FB] px-4 py-3 rounded-2xl border border-black/5 text-[11px] focus:border-slate-900 outline-none resize-none"
                          />
                          <div className="flex justify-between items-center px-1 text-[11px] sm:text-[11px] sm:text-[11px] text-black/45">
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-black/5">
                      <button type="submit" disabled={isSaving} className="px-8 py-3 bg-black text-white rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold hover:bg-black hover:text-black transition-colors">{isSaving ?"Saving..." : editingId ?"Update Setup" :"Publish Theme"}</button>
                      <button type="button" onClick={handleCancel} className="px-6 py-3 bg-white border border-stone-200 text-stone-700 rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold">Cancel</button>
                    </div>
                  </form>
                </motion.div>
              )}
                ...
                {events.map((ev) => (
                  <div key={ev._id || ev.id} className="bg-white border border-black/5 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between">
                    <div className="relative aspect-[16/10] overflow-hidden shrink-0">
                      ...
                      <span className="absolute top-3 left-3 bg-white/95 px-2 py-0.5 rounded-full font-medium tracking-wide text-[7px] uppercase tracking-widest font-bold">{ev.category}</span>
                    </div>
                    <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                      <div>
                        <div className="flex justify-between items-start gap-1">
                          <h4 className="text-[11px] text-black font-bold leading-tight">{ev.title}</h4>
                          <span className="text-[11px] text-black italic shrink-0 font-semibold">{ev.pricing}</span>
                        </div>
                        <p className="font-body text-[11px] sm:text-[11px] text-black/40 mt-1 line-clamp-2 leading-relaxed">{ev.description}</p>
                      </div>
          ...
          <motion.div key="inventory" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="bg-white rounded-3xl border border-black/5 shadow-sm p-6 space-y-4">
              <div className="flex justify-between items-center border-b border-black/5 pb-2 bg-stone-50 p-4 rounded-xl">
                <h3 className="text-[11px] text-black font-bold">Rental Inventory stock ledger</h3>
                <span className="bg-stone-200 text-stone-700 px-3 py-1 rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {operationsLoading ? (
                  <div className="col-span-full py-10 text-center text-[11px] text-black/40">Loading live inventory...</div>
                  ...
                  <div key={idx} className="p-4 bg-[#F8F9FB] border border-black/5 rounded-2xl flex flex-col justify-between h-36">
                    <div>
                      <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-medium tracking-wide text-[7px] uppercase tracking-widest font-bold">{prop.status}</span>
                      <h4 className="text-[11px] text-black font-bold mt-2 leading-tight">{prop.item}</h4>
                    </div>
                    <div className="flex justify-between items-end border-t border-black/5 pt-2 text-[11px]">
                  ...
                  <div className="col-span-full py-10 text-center text-[11px] text-black/40">No product inventory is available yet.</div>
                )}
              </div>
            </div>
          </motion.div>
        ...
        {activeTab ==="team" && (
          <motion.div key="team" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            <div className="bg-white rounded-3xl border border-black/5 shadow-sm p-6 space-y-4">
              <div className="flex justify-between items-center border-b border-black/5 pb-2 bg-stone-50 p-4 rounded-xl">
                <h3 className="text-[11px] text-black font-bold">Available Setup Staff & Crew</h3>
                <span className="bg-stone-200 text-stone-700 px-3 py-1 rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {operationsLoading ? (
                  <div className="col-span-full py-10 text-center text-[11px] text-black/40">Loading live staff list...</div>
                  ...
                  <div key={idx} className="p-4 bg-[#F8F9FB] border border-black/5 rounded-2xl flex items-center justify-between">
                    <div>
                      <h4 className="text-[11px] text-black font-bold">{team.name}</h4>
                      <span className="font-body text-[11px] text-black/40 block mt-0.5 capitalize">{team.role}</span>
                      <span className="font-mono text-[11px] sm:text-[11px] sm:text-[11px] text-black/50 block mt-1">{team.contact}</span>
                    </div>
                    <span className="bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full font-medium tracking-wide text-[11px] uppercase tracking-widest font-bold">Available</span>
                  </div>
                )) : (
                  <div className="col-span-full py-10 text-center text-[11px] text-black/40">No team members are available for allocation yet.</div>
                )}
              </div>
            </div>
          </motion.div>
        ...
        {activeTab ==="showcases" && (
          <motion.div key="showcases" initial="hidden" animate="show" variants={fadeUp} className="space-y-6">
            ...
            <div className="flex justify-between items-center bg-white p-6 rounded-3xl border border-black/5 shadow-sm">
              <div>
                <h3 className="text-[11px] text-black font-bold">Tambulam & Gift Presentation Designs</h3>
                <p className="font-body text-[11px] text-black/40">Manage Telugu Tambulam, coconut decor, and traditional wedding items.</p>
              </div>
              <button
                onClick={() => {
                ...
                className="px-5 py-2.5 bg-black text-white rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold shadow-md hover:bg-stone-900 transition-colors flex items-center gap-1.5 cursor-pointer"
              >
            ...
            {showShowcaseForm && (
              <form onSubmit={handleCreateOrUpdateShowcase} className="bg-white p-6 md:p-8 rounded-3xl border border-black/5 shadow-md space-y-6">
                <div className="border-b border-black/5 pb-4">
                  <h4 className="text-[11px] text-black font-bold">
                    {editingShowcaseId ?"Edit Showcase Collection" :"Create Traditional Design"}
                  </h4>
                  <p className="font-body text-[11px] sm:text-[11px] text-black/45">Provide details for traditional wedding, ring ceremony, or gift setups.</p>
                </div>
                ...
                <div className="bg-[#F8F9FB] p-6 rounded-3xl border border-slate-250 space-y-4 shadow-sm">
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black font-bold block">Step 1: Upload Photo Blueprint *</span>
                      <p className="text-[11px] sm:text-[11px] text-black/50">Upload or link your cover photography first. Our AI Vision model can analyze props and recommend pricing.</p>
                    </div>
                    {showcaseForm.image && (
                      <span className="bg-emerald-100 text-emerald-800 text-[11px] sm:text-[11px] sm:text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">✓ Photo Active</span>
                    )}
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                    <div className="md:col-span-2 space-y-2">
                      <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Cover Image URL *</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full px-4 py-3 text-[11px] border border-black/10 rounded-xl bg-white focus:border-slate-900 outline-none shadow-xs font-mono"
                      />
                    </div>
                    <div>
                      <ImageUpload
                ...
                <div className="flex justify-end pr-2">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-full bg-black hover:bg-stone-900 text-white font-medium tracking-wide text-[11px] uppercase tracking-widest font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 cursor-pointer active:scale-95 select-none"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                  {/* Title */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Showcase Title *</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full px-4 py-2 text-[11px] border border-black/10 rounded-xl bg-stone-50/50 focus:bg-white focus:border-slate-900 outline-none"
                    />
                  </div>

                  {/* Subtitle */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Artisan Subtitle</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Showcase Category *</label>
                      <button
                        type="button"
                        onClick={() => setShowCatModal(true)}
                        className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] text-black hover:underline font-bold flex items-center gap-1 cursor-pointer"
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 text-[11px] border border-black/10 rounded-xl bg-white focus:border-slate-900 outline-none font-medium"
                    >
                      <option value="">Select Category</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {/* Daily Rental Price */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Daily Rental Price (₹) *</label>
                    <input
                      type="number"
                      required
                      placeholder="15000"
                      ...
                      className="w-full px-4 py-2 text-[11px] border border-black/10 rounded-xl bg-stone-50/50 focus:bg-white focus:border-slate-900 outline-none font-mono"
                    />
                  </div>

                  {/* Lead Setup Time */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Estimated Setup Time (Hours)</label>
                    <input
                      type="number"
                      placeholder="2"
                  ...
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Storefront Availability</label>
                    <div 
                    ...
                    >
                      ...
                      />
                      <label htmlFor="isActive" className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/60 font-bold cursor-pointer select-none">Theme Active for Rentals</label>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Color Palette */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Accent Silk Thread Color Palette (Hex codes, comma separated)</label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-2 text-[11px] border border-black/10 rounded-xl bg-stone-50/50 focus:bg-white focus:border-slate-900 outline-none"
                    />
                    <p className="text-[11px] text-black/35 font-light">Accent color palette for showcase visualization tags.</p>
                  </div>

                  {/* Inclusions Text box */}
                  <div className="space-y-1">
                    <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Handcrafted Modular Inclusions (Comma-separated props list)</label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-2 text-[11px] border border-black/10 rounded-xl bg-stone-50/50 focus:bg-white focus:border-slate-900 outline-none"
                    />
                    <p className="text-[11px] text-black/35 font-light">Each prop split by a comma will become an independent, selectable item in the customer Visual Crate customizer.</p>
                  </div>
                </div>

                {/* Description */}
                <div className="space-y-1">
                  <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Artisan Arrangement Story Narrative *</label>
                  <textarea
                    required
                    ...
                    className="w-full p-4 text-[11px] border border-black/10 rounded-xl bg-stone-50/20 focus:bg-white focus:border-slate-900 outline-none h-28 resize-none"
                  />
                </div>
                ...
                <div className="border-t border-black/5 pt-4 space-y-4">
                  <div>
                    ...
                    <p className="text-[11px] text-black/40 mt-0.5">Configure custom search engine tags to optimize the discovery of this showcase rental item.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-black/10 bg-stone-50/50 focus:bg-white focus:border-slate-900 outline-none text-[11px]"
                      />
                      <div className="flex justify-between items-center px-1 text-[11px] sm:text-[11px] sm:text-[11px] text-black/45">
                        <span>Recommended: 50-60 characters</span>
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        className="w-full p-4 text-[11px] border border-black/10 rounded-xl bg-stone-50/20 focus:bg-white focus:border-slate-900 outline-none resize-none"
                      />
                      <div className="flex justify-between items-center px-1 text-[11px] sm:text-[11px] sm:text-[11px] text-black/45">
                        <span>Recommended: 150-160 characters</span>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button
                    ...
                    className="px-5 py-2.5 border border-black/10 text-black rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold hover:bg-stone-50 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-6 py-2.5 bg-black text-white rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold shadow-md hover:bg-stone-900 transition-colors"
                  >
            ...
            <div className="bg-white p-6 rounded-3xl border border-black/5 shadow-sm space-y-4">
              <h4 className="text-[11px] text-black font-bold">Tambulam & Gift Presentation Designs</h4>
              ...
              {loadingShowcases ? (
                ...
                <div className="p-12 text-center text-black/35 font-body text-[11px]">
                    ...
                    <div key={sc._id || sc.id} className="border border-black/5 bg-[#F8F9FB] rounded-2xl overflow-hidden flex flex-col justify-between">
                      <div>
                        <div className="relative h-40 overflow-hidden bg-stone-100">
                          ...
                          <span className="absolute top-2 left-2 bg-stone-900/80 text-white font-medium tracking-wide text-[7px] uppercase tracking-widest px-2 py-0.5 rounded-full font-bold">
                            {sc.category?.replace("_","")}
                          </span>
                        </div>
                        <div className="p-4 space-y-2">
                          <h4 className="text-[11px] text-black font-bold leading-tight truncate">{sc.title}</h4>
                          <span className="font-mono text-[11px] font-bold text-black block">₹{sc.rentalPrice.toLocaleString("en-IN")} / day</span>
                          <p className="font-body text-[11px] sm:text-[11px] text-black/45 line-clamp-2 leading-relaxed">{sc.description}</p>
                          
                          {/* Inclusions count */}
                          <div className="flex flex-wrap gap-1 pt-1">
                            {sc.inclusions?.map((inc, idx) => (
                              <span key={idx} className="bg-white border border-black/5 px-2 py-0.5 rounded-full font-body text-[11px] text-black/65">
                                {inc.name}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className="p-4 border-t border-black/5 flex gap-2">
                        <button
                          ...
                          className="flex-1 py-1.5 bg-stone-100 text-black hover:bg-slate-200 hover:text-black rounded-xl font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold flex items-center justify-center gap-1 transition-colors cursor-pointer"
                        >
                          <span className="material-symbols-outlined text-[13px]">edit</span> Edit
                        </button>
                        <button
                          onClick={() => handleDeleteShowcase(sc._id || sc.id)}
                          className="py-1.5 px-3 bg-red-50 text-red-600 hover:bg-red-100 rounded-xl font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold flex items-center justify-center gap-1 transition-colors cursor-pointer"
                        >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 border-r border-black/5">
                <div className="flex justify-between items-start border-b border-black/5 pb-4">
                  <div>
                    <span className="font-medium tracking-wide text-[11px] text-black uppercase tracking-[0.25em] font-bold block mb-1">EVENT BOOKING DETAILS</span>
                    <h3 className="text-[11px] text-black font-bold leading-tight">{selectedBooking.title}</h3>
                    <p className="font-body text-[11px] text-black/40 capitalize mt-0.5">Customer: {selectedBooking.user?.name} | {selectedBooking.user?.phone}</p>
                  </div>
                ...
                <div className="space-y-2">
                  <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Change Booking Status</label>
                  <select
                    value={drawerStatus}
                    onChange={(e) => handleUpdateStatus(e.target.value)}
                    className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] focus:border-slate-900 outline-none cursor-pointer capitalize font-semibold text-black"
                  >
                    {[
                ...
                <div className="space-y-4 pt-4 border-t border-black/5">
                  <span className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Price Estimates</span>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Theme Rental Fee (₹)</label>
                      <input type="number" value={quoteRental} onChange={(e) => setQuoteRental(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" />
                    </div>
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Labor & Setup Charges (₹)</label>
                      <input type="number" value={quoteSetup} onChange={(e) => setQuoteSetup(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" />
                    </div>
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Transportation Cost (₹)</label>
                      <input type="number" value={quoteTransport} onChange={(e) => setQuoteTransport(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" />
                    </div>
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Add-ons Charges (₹)</label>
                      <input type="number" value={quoteAddons} onChange={(e) => setQuoteAddons(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" disabled />
                    </div>
                  </div>
                  <button onClick={handleUpdateQuotation} className="w-full bg-black text-white py-2.5 rounded-full font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest font-bold hover:bg-black hover:text-black transition-colors shadow">Save & Send Price Estimate</button>
                </div>

                {/* Logistics schedule timestamps */}
                <div className="space-y-4 pt-4 border-t border-black/5">
                  <span className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Setup & Pickup Schedule</span>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Setup Time</label>
                      <input type="datetime-local" value={logisticsSetup} onChange={(e) => setLogisticsSetup(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" />
                    </div>
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/40 block">Pickup Time</label>
                      <input type="datetime-local" value={logisticsPickup} onChange={(e) => setLogisticsPickup(e.target.value)} className="w-full bg-[#F8F9FB] px-4 py-2 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900" />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-black/5">
                  <div className="flex items-center justify-between">
                    <span className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-[var(--color-gold-dark)] font-bold block">Celebration Venue & Map Coordinates</span>
                    <span className="bg-[#FAF6F0] text-[var(--color-gold-dark)] border border-[#C4A87C]/20 px-2.5 py-0.5 rounded-full font-medium tracking-wide text-[7px] uppercase tracking-widest font-bold">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px]">
                    <div className="space-y-1 sm:col-span-2">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Venue / Landmark Name *</label>
                      <input
                        type="text"
                        value={venueName}
                        onChange={(e) => setVenueName(e.target.value)}
                        placeholder="e.g. Siri Heritage Palace Hall"
                        className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900 font-medium"
                      />
                    </div>

                    <div className="space-y-1 sm:col-span-2">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Full Address *</label>
                      <textarea
                        rows={2}
                        value={venueAddress}
                        onChange={(e) => setVenueAddress(e.target.value)}
                        placeholder="e.g. 12th Cross Road, Indira Nagar, Bengaluru..."
                        className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-[1.25rem] border border-black/5 text-[11px] outline-none focus:border-slate-900 resize-none font-medium"
                      />
                    </div>

                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">City</label>
                      <input
                        type="text"
                        value={venueCity}
                    ...
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">State</label>
                      <input
                        type="text"
                        value={venueState}
                    ...
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Country</label>
                      <input
                        type="text"
                        value={venueCountry}
                    ...
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Pincode/ZIP</label>
                      <input
                        type="text"
                        value={venuePincode}
                    ...
                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Latitude</label>
                      <input
                        type="number"
                        step="any"
                        value={venueLatitude}
                        ...
                        placeholder="15.506"
                        className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-full border border-black/5 text-[11px] outline-none focus:border-slate-900 font-mono"
                      />
                    </div>

                    <div className="space-y-1">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Longitude</label>
                      <input
                        type="number"
                        step="any"
                    ...
                    <div className="space-y-1 sm:col-span-2">
                      <label className="font-body text-[11px] text-black/45 block font-semibold">Google Maps Navigation Link</label>
                      <input
                        type="text"
                    ...
                    <div className="sm:col-span-2 flex items-center gap-2 pt-1">
                      ...
                      />
                      <label htmlFor="venueIsOutdoor" className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block cursor-pointer select-none">
                ...
                <div className="space-y-3 pt-4 border-t border-black/5">
                  <span className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Assign Setup Staff</span>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {teamMembers.map((member) => {
                      ...
                      return (
                        ...
                        >
                          <div>
                            <span className="font-body text-[11px] text-black font-bold block">{member.name}</span>
                            <span className="font-body text-[11px] text-black/40 block capitalize">{member.role}</span>
                          </div>
                ...
                {/* Props checklists */}
                <div className="space-y-3 pt-4 border-t border-black/5">
                  <span className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-widest text-black/50 font-bold block">Select Props Checklist</span>
                  <div className="space-y-2">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {inventoryItems.map((prop) => {
                        ...
                        return (
                          ...
                          >
                            <span className="font-body text-[11px] sm:text-[11px] text-black font-bold block leading-tight">{prop.item}</span>
                    ...
                    {allocatedProps.length > 0 && (
                      <div className="pt-4 border-t border-black/5 space-y-2.5">
                        <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black/40 block">Prop Returns & Tracking</span>
                        {allocatedProps.map((p, idx) => (
                          <div key={idx} className="flex justify-between items-center bg-stone-50 border border-black/5 p-3 rounded-xl text-[11px]">
                            <span className="font-body text-[11px] sm:text-[11px] text-stone-700 font-bold leading-tight max-w-[200px] truncate">{p.item}</span>
                            <select
                              value={p.returnStatus}
                              onChange={(e) => handlePropReturnStatusChange(idx, e.target.value)}
                              className="bg-white border border-black/5 px-3 py-1 rounded-lg text-[11px] outline-none"
                            >
                ...
                <div className="space-y-2 pt-4 border-t border-black/5">
                  <label className="font-medium tracking-wide text-[11px] sm:text-[11px] sm:text-[11px] uppercase tracking-wider text-black/50 font-bold block">Internal Staff & Setup Notes</label>
                  <textarea
                    rows={2}
                    value={drawerNotes}
                    onChange={(e) => setDrawerNotes(e.target.value)}
                    placeholder="Enter internal notes, staff times, or setup instructions..."
                    className="w-full bg-[#F8F9FB] px-4 py-2.5 rounded-xl border border-black/5 text-[11px] outline-none focus:border-slate-900 resize-none"
                  />
                </div>

                <button onClick={handleUpdateLogistics} className="w-full bg-black text-white py-3 rounded-full font-medium tracking-wide text-[11px] uppercase tracking-widest font-bold hover:bg-black hover:text-black transition-colors shadow-lg">Save Timeline & Staff</button>
              </div>
              ...
              <div className="w-full md:w-[320px] bg-stone-50 p-4 md:p-6 flex flex-col h-full shrink-0 border-t md:border-t-0 border-black/5">
                <div className="border-b border-black/5 pb-3 shrink-0 flex items-center justify-between">
                  <div>
                    <span className="font-medium tracking-wide text-[11px] uppercase tracking-widest text-black font-bold block">CLIENT CHAT</span>
                    <h4 className="text-[11px] text-black font-bold">Customer Chat</h4>
                  </div>
                  ...
                  {selectedBooking.chatHistory?.map((chat, idx) => {
                    ...
                    return (
                      <div key={idx} className={`flex flex-col max-w-[85%] ${isAdmin ?"self-end text-right ml-auto" :"self-start text-left"}`}>
                        <span className="font-medium tracking-wide text-[11px] text-black/35 font-bold uppercase tracking-widest mb-1 block">
                          {isAdmin ?"You" :"Client"}
                        </span>
                        <div className={`p-3.5 rounded-[18px] text-[11px] leading-relaxed font-light ${
                          isAdmin ?"bg-black text-white rounded-tr-none" :"bg-white text-stone-900 border border-black/5 rounded-tl-none"
                        }`}>
                          {chat.message}
                        </div>
                        <span className="font-mono text-[11px] text-black/25 mt-1 block">
                ...
                <form onSubmit={handleSendAdminChat} className="border-t border-black/5 pt-3 shrink-0 flex items-center gap-2 mt-auto">
                  <input
                    ...
                    className="flex-1 bg-white border border-black/5 px-4 py-2.5 rounded-full text-[11px] outline-none focus:border-slate-900 transition-colors"
                    required
                  />

    ...
    >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {order.orderType && order.orderType !== 'purchase' && (
                <span
                  className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-xl shadow-sm border ${
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto mt-2 sm:mt-0 shrink-0">
        <button
          ...
          className="admin-btn admin-btn-primary flex-1 sm:flex-none h-10 px-3 sm:px-5 rounded-lg shadow-sm text-[12px] sm:text-[13px] font-bold min-w-max"
        >
        ...
        <button
          ...
          className="admin-btn admin-btn-outline flex-1 sm:flex-none h-10 px-3 sm:px-5 rounded-lg text-[12px] sm:text-[13px] font-bold shadow-sm min-w-max"
        >

      ...
      <div className="relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-6">
          <div className="max-w-4xl w-full text-center mt-12">
            ...
            <div className="mt-8">
              <Link to="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white rounded-full font-bold text-lg hover:bg-primary-dark transition-colors shadow-xl hover:shadow-2xl transform hover:-translate-y-1 duration-300">
                Book a Consultation
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop mt-16 md:mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <div className="pt-6">
              <Link to="/gallery" className="inline-flex items-center text-primary font-bold text-lg hover:text-primary-dark transition-colors group">
        ...
        {locationObj.faqs && locationObj.faqs.length > 0 && (
          <div className="mt-24 pt-16 border-t border-outline-variant/30">
            <FAQAccordion faqs={locationObj.faqs} title={`Common Questions about our Services in ${locationObj.city}`} />
          </div>
        )}

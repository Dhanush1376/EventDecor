...
export function GalleryInspiration() {
  ...
  return (
    <section className="h1-section py-16 bg-surface relative overflow-hidden isolate" id="h1-inspiration">
        ...
        <div className="columns-2 md:columns-3 lg:columns-4 gap-3 md:gap-5.5 space-y-3 md:space-y-5.5 relative z-10">
          ...
          >
            ...
            >
              ...
              <h3 className="font-display text-[16px] md:text-[18px] mb-2 text-center leading-tight">{galleryPreview?.ctaTitle || 'View All Inspiration'}</h3>

...
export function AboutFounders({ founders }) {
  ...
  return (
    <StackedSectionWrapper index={5} isLast={false} bgClass="bg-surface-bright">
      <section className="py-24 lg:py-40 relative bg-surface-bright overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center mb-16 lg:mb-24">
          ...
          <motion.h2
            ...
            className="font-headline text-[42px] lg:text-[56px] leading-[1.1] tracking-tight"
          >
            Guiding the Studio
          </motion.h2>
        </div>

        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 items-start gap-16 lg:gap-24 relative z-10">
          {founders?.map((founder, index) => (
            <div key={index} className="space-y-8 flex flex-col items-center lg:items-center">
              <motion.div
                ...
                className="relative w-full max-w-[280px] aspect-square bg-white rounded-[32px] lg:rounded-[40px] p-4 lg:p-6 shadow-[0_30px_60px_rgba(0,0,0,0.06)] border border-black/[0.02] flex items-center justify-center group"
              >
                <div className="w-full h-full rounded-[24px] lg:rounded-[32px] overflow-hidden relative bg-surface-container-low flex items-center justify-center">
                  <MandalaElement
                    size={240}
                    duration={180}
                    variant={index === 0 ? 1 : 2}
                  ...
                  <span className="font-display text-[48px] lg:text-[64px] text-primary/20 select-none">
                    {founder.initials}
                  </span>
                </div>
              </motion.div>
              ...
              <div className="space-y-6 w-full text-center lg:text-center">
                ...
                <h3 className="font-headline text-[32px] lg:text-[42px] leading-tight">
                  {founder.name} <br />
                ...
                >
                  <img
                    ...
                    className="h-14 lg:h-16 opacity-90 mix-blend-multiply filter grayscale contrast-150 -ml-4"

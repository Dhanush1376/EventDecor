        ...
        {returns.length === 0 ? (
          <div className="bg-surface-bright rounded-3xl p-12 text-center shadow-sm flex flex-col items-center justify-center min-h-[50vh] relative overflow-hidden border border-black/5">
            ...
            <motion.div
              ...
              className="w-24 h-24 rounded-full bg-primary/5 text-primary flex items-center justify-center mb-8 relative"
            >
              <div
            ...
            <p className="text-[13px] text-black/50 max-w-[320px] mb-8 leading-relaxed">
              You don't have any active return or exchange requests. Need to send something back?
              Check your order history to initiate a return.
            </p>

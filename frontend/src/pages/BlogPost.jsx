      ...
      <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop mt-8 md:mt-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 max-w-3xl mx-auto lg:mx-0 w-full">
            <Link
              to="/blog"
              className="inline-flex items-center text-on-surface-variant hover:text-primary transition-colors mb-8 font-medium"
            >
                ...
                switch (block.type) {
                  case 'h2':
                    return (
                      <h2
                        key={index}
                        className="font-display text-3xl font-bold mt-12 mb-6 text-on-surface"
                      >
                        {block.text}
                      </h2>
                    );
                  case 'h3':
                    return (
                      <h3
                        key={index}
                        className="font-display text-2xl font-semibold mt-8 mb-4 text-on-surface"
                      >
                        {block.text}
                      </h3>
                    );
                  case 'p':
                    return (
                      <p key={index} className="mb-6 text-on-surface-variant leading-loose">
                        {block.text}
                      </p>
                    );
                  default:
            ...
            <div className="mt-12 pt-8 border-t border-outline-variant/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  className="px-4 py-2 rounded-full bg-surface-variant text-sm font-bold text-on-surface hover:bg-primary hover:text-white transition-colors"
                >
                  Facebook
                </a>
                <a

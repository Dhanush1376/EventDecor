...
import { EVENT_TYPES } from './useEventBookingForm';
            ...
            <div className="space-y-4 pt-2">
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 bg-white border border-black/10 py-2.5 rounded-full font-semibold text-xs"
                >
                  Choose on Map
                </button>
                <button
                  onClick={() => actions.setIsManualLocationInput(!state.isManualLocationInput)}

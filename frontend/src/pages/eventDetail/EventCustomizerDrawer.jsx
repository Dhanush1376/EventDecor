    ...
    <AnimatePresence>
      ...
      {state.isDrawerOpen && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 lg:top-0 lg:bottom-0 lg:my-auto lg:h-fit lg:left-0 lg:right-0 lg:mx-auto lg:w-[600px] lg:rounded-[2.5rem] lg:overflow-hidden z-[1000] bg-[#FCFAF6] border-t border-black/10 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.15)] flex flex-col max-h-[85vh] lg:max-h-[90vh] keyboard-aware-drawer"
        >
          <div className="absolute top-[98%] left-0 right-0 h-[100vh] bg-[#FCFAF6] lg:hidden z-[-1]" />

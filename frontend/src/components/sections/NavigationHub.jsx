...
export function NavigationHub() {
  ...
  const sectionSubtitle =
    ...
    'Explore our most sought-after ceremonial masterpieces, meticulously designed to elevate your celebrations.';
              ...
              {deck.length > 0 &&
                deck.map((id, index) => {
                  ...
                  return (
                    <motion.div
                      key={card.id}
                      className="absolute w-[85vw] max-w-[330px] h-[430px] rounded-2xl overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)] border border-black/5 bg-white origin-bottom cursor-pointer"
                      style={{
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`relative w-full h-full flex flex-col rounded-2xl overflow-hidden bg-white border border-black/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:shadow-[0_20px_60px_rgb(0,0,0,0.12)] group-hover:-translate-y-2`}
                  >
                    ...
                    <div className="relative w-full aspect-[4/5] overflow-hidden bg-stone-100">
                      ...
                      <div className="absolute inset-0 border-[1.5px] border-white/10 rounded-2xl pointer-events-none" />

...
export function MapLocationPicker({ position, setPosition, fetchAddressFromCoords }) {
  ...
  useEffect(() => {
    const initMap = () => {
      ...
      const map = L.map('dashboard-leaflet-map').setView([initialPos.lat, initialPos.lng], 13);

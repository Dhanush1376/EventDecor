    ...
    <AnimatePresence>
      {isMobileChatOpen && selectedBooking && (
        <>
          ...
          {/* Visual viewport height restricted container */}
          <div
            className="fixed top-0 left-0 w-full z-[100] flex flex-col justify-end lg:hidden pointer-events-none"

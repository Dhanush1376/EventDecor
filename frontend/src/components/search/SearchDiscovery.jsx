      ...
      {recentSearches.length > 0 && (
        <div className={isMobile ? 'py-1' : 'mb-2'}>
          ...
          {recentSearches.map((search) => (
            ...
            >
              <span className="material-symbols-outlined text-[18px] text-stone-400">history</span>
              <span
                className={`flex-1 ${
                  isMobile
              ...
              >
                <span className="material-symbols-outlined text-[16px] text-stone-400">close</span>
              </button>
            </div>
          ))}
        </div>

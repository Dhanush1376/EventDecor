...
const STYLE_OPTIONS = [
  'Traditional', 'Modern', 'Luxury', 'Floral', 'Minimalist', 'Rustic'
];
        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10 scrollbar-none">
              ...
              {/* Color Palette */}
              <div>
                <h4 className="font-label uppercase tracking-widest text-[11px] text-black/50 font-bold mb-4">Color Palette</h4>
                  ...
                  {COLOR_PALETTES.map((color) => {
                    ...
                    return (
                      <button
                        ...
                        style={{ backgroundColor: color.hex, boxShadow: color.hex === '#FFFFFF' ? 'inset 0 0 0 1px rgba(0,0,0,0.1)' : 'none' }}
                        title={color.name}
                      >
                        {isSelected && (
                          <div className={`absolute inset-0 flex items-center justify-center ${color.hex === '#FFFFFF' || color.hex === '#FFD700' ? 'text-black' : 'text-white'}`}>
              ...
              {/* Styles */}
              <div>
                <h4 className="font-label uppercase tracking-widest text-[11px] text-black/50 font-bold mb-4">Design Style</h4>

...
const FacebookIcon = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>;
...
export function ShareButton({ 
  ...
  const baseStyles = "inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-50";
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-medium text-neutral-500 whitespace-nowrap">{social.name.split(' ')[0]}</span>
                </a>
              ))}
            </div>

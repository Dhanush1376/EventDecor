...
export const QuickViewModal = ({ isOpen, onClose, product, onNext, onPrev, hasNext, hasPrev }) => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div
          className="fixed top-0 left-0 w-full h-[100dvh] z-[200] flex items-end lg:items-center justify-center p-3 sm:p-4 lg:p-8 pb-[max(16px,var(--safe-area-bottom,_env(safe-area-inset-bottom)))] lg:pb-8"
          role="dialog"
          aria-modal="true"

      ...
      {networkState === 'offline' && (
        ...
        >
          ...
          >
            ...
            >
              Please check your internet connection and try again. Your offline activity is
              protected and will sync automatically.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
              <button
                ...
                className={`w-full sm:w-auto min-w-[200px] flex items-center justify-center gap-2 btn-primary py-3.5 ${
                  isVerifying
                    ? 'opacity-90 pointer-events-none bg-primary-container text-on-primary-container'
                    : ''
                }`}
              >
                <RefreshCw className={`w-4 h-4 tracking-widest `} strokeWidth={2} />

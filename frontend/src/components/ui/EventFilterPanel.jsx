    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pr-2">
        ...
        <FilterSection title="Price Range" id="price">
          <Checkbox type="price" label="Under ₹1,00,000" />
          <Checkbox type="price" label="₹1,00,000 - ₹3,00,000" />
          <Checkbox type="price" label="₹3,00,000 - ₹5,00,000" />
          <Checkbox type="price" label="Over ₹5,00,000" />
        </FilterSection>
        ...
        <FilterSection title="Occasion" id="occasion">
          {categories
            ...
            .map((cat) => (
              <Checkbox key={cat} type="occasion" label={cat} />
            ))}
        </FilterSection>
        ...
        <FilterSection title="Style" id="style">
          {styles
            ...
            .map((style) => (
              <Checkbox key={style} type="style" label={style} />
            ))}
        </FilterSection>
      </div>
    </div>

    ...
    <section className="pt-2 pb-10 lg:py-36 bg-[#FDFBF7] relative overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 lg:px-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 lg:mb-28 relative z-10">
          <div className="inline-flex items-center justify-center px-5 py-2 rounded-full border border-outline-variant/30 bg-white/50 mb-4 lg:mb-8">
          ...
          <div className="space-y-4 mb-4 lg:mb-8">
            <Skeleton className="h-[48px] lg:h-[84px] w-[80%] mx-auto" />
            <Skeleton className="h-[48px] lg:h-[84px] w-[60%] mx-auto" />
          </div>
        ...
        <div className="lg:hidden relative w-full flex flex-col items-center justify-center min-h-[490px] z-20 mt-2">
        ...
        <div className="hidden lg:grid md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8 xl:gap-10 relative z-20">
          {[...Array(4)].map((_, index) => (
            <div
              key={index}

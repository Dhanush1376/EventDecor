...
export function BestsellerSkeleton() {
  return (
    <div className="py-16 lg:py-29 relative overflow-hidden bg-surface-bright">
      <div className="max-w-[1440px] mx-auto px-[clamp(22px,4.5vw,72px)]">
        {/* Header Section */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-7 mb-14 lg:mb-22 relative z-10">
          <div className="max-w-2xl flex flex-col items-center lg:items-start text-center lg:text-left w-full">
            ...
            <div className="space-y-4 w-full flex flex-col items-center lg:items-start">
              <Skeleton className="h-[42px] lg:h-[65px] w-3/4" />
              <Skeleton className="h-[42px] lg:h-[65px] w-1/2" />
            </div>
          </div>
        ...
        {/* Desktop Layout */}
        <div className="hidden lg:flex gap-9 overflow-x-hidden pb-11 -mx-8 px-8 relative z-10">
          {[...Array(4)].map((_, i) => (

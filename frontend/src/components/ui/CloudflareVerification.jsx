        ...
        <div className="border border-gray-700 bg-[#1a1a1a] rounded-sm p-4 w-full max-w-[480px] flex items-center justify-between shadow-xl">
              ...
              {[...Array(8)].map((_, i) => (
                <div 
                  ...
                  style={{
                    ...
                    opacity: isVerifying ? (i === dots || i === (dots - 1 + 8) % 8 || i === (dots - 2 + 8) % 8 ? 1 : 0.2) : 1,
          ...
          <div className="flex flex-col items-end">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              >
                <path d="M19.16 9.54c-.16-.94-.78-1.74-1.63-2.12-.13-1.6-1.12-3-2.61-3.61-1.49-.61-3.21-.49-4.57.34C9.53 2.92 7.78 2.22 5.92 2.66c-1.86.44-3.3 1.88-3.74 3.74-.29 1.25-.01 2.56.76 3.63C1.69 11.23 1 12.8 1 14.5c0 2.48 2.02 4.5 4.5 4.5h13c2.48 0 4.5-2.02 4.5-4.5 0-2.31-1.74-4.23-3.84-4.96z" fill="currentColor"/>
              </svg>

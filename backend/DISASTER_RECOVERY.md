...
|--------|--------|------------|
| **RTO** (Recovery Time Objective) | < 30 minutes | Maximum acceptable time to restore service after a complete outage. |
| **RPO** (Recovery Point Objective) | < 1 hour | Maximum acceptable data loss window for transactions. |
| **MTTR** (Mean Time to Recover) | < 15 minutes | Average time to recover from common component failures. |
...
**Recovery Strategy (Data Corruption):**
...
**Symptoms:** Rate limits fail-open or fall back to memory, live user sessions drop.
**Recovery Strategy:**
...
### 3.4 Scenario 4: Total Region Loss / Complete Environment Failure
**Recovery Strategy:**

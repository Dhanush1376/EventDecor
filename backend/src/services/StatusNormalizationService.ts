...
export class StatusNormalizationService {
  ...
  static normalizePurchaseStatus(rawStatus: string): string {
    ...
    const map: Record<string, string> = {
      'pending cod': PURCHASE_STATUS.PENDING_PAYMENT,
      pending_payment: PURCHASE_STATUS.PENDING_PAYMENT,
      ...
      packed: PURCHASE_STATUS.PACKED,
      shipped: PURCHASE_STATUS.DISPATCHED,
      dispatched: PURCHASE_STATUS.DISPATCHED,
      in_transit: PURCHASE_STATUS.IN_TRANSIT,
      'out for delivery': PURCHASE_STATUS.OUT_FOR_DELIVERY,

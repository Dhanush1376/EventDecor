...
const backupPath = path.resolve(__dirname, '../../recovery/backups/full_backup_2026-06-06T11-50-54-577Z.json');
...
async function restoreBackup() {
  ...
  const productsBackupPath = path.resolve(__dirname, '../../recovery/backups/products_daily_export_2026-06-06T11-57-47-535Z.json');

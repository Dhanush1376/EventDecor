    ...
    items: [
      {
        ...
        link: '/collections?category=Traditional+Wedding+Decor',
      ...
      },
      {
        id: 2,
        name: 'Pooja & Rituals',
        link: '/collections?category=Pooja+Decoration+Sets',
        image: IMAGES.templeStyleMandap,
        isVisible: true,
      },
      {
        id: 3,
        name: 'Engagement Trays',
        link: '/collections?category=Engagement+Ring+Trays',
      ...
      },
      {
        id: 4,
        name: 'Gift Hampers',
        link: '/collections?category=Customized+Gift+Hampers',
  ...
  digitalStudio: {
    ...
    visualThemes: [
      {
        id: 'Royal',
        label: 'Royal Palace',
        desc: 'Heirloom gold setups with custom silk drapery.',
        img: IMAGES.luxuryRoyalWedding,
      },
      {
        id: 'Heritage',
        label: 'Heritage Botanicals',
        desc: 'Vibrant custom botanical archways.',
    ...
    venueSizes: [
      {
        ...
        desc: 'Perfect for home functions.',
      ...
      },
      {
        ...
        desc: 'Optimized for hotel ballrooms.',
      ...
      },
      {
        ...
        desc: 'Majestic layout for broad entrance.',
    ...
    packageModules: [
      ...
      },
      {
        ...
        basePrice: 85000,
        desc: 'Suspended botanical overhead',
        isPopular: true,
      },
      {
        id: 'stage',
        label: 'Stage Setup',
        basePrice: 120000,
        desc: 'Main backdrop relief platforms',
        isPopular: true,
      },
      {
        id: 'lighting',
...
const masterEventsData = [
  {
    ...
    subtitle: 'Sacred Gold & Crimson Sanctuary',
    category: 'Wedding Ceremony',
    style: 'Royal',
    image: IMAGES.luxuryRoyalWedding,
    decorCount: '120+ Decor Elements',
    venueType: 'Indoor Banquet & Heritage Lawns',
    pricing: 'Starting at Rs. 3,50,000',
    description: 'An architectural masterpiece inspired by palace courtyards.',
    colorPalette: ['#f5f0eb', '#d4af37', '#8b0000'],
    features: ['24K Gold Plated Pavilion Archways', 'Handwoven Pure Zardozi Backdrops'],
    venueSize: 'Grand Ballroom & Heritage Lawns',
    gallery: [IMAGES.luxuryRoyalWedding, IMAGES.templeStyleMandap],
  },
  {
    title: 'Traditional Wedding Decor',
    subtitle: 'Sacred South Indian Heritage',
    category: 'Wedding Ceremony',
    style: 'South Indian',
    image: IMAGES.templeStyleMandap,
    decorCount: '95+ Decor Elements',
    venueType: 'Traditional Pavilion & Open Lawns',
    pricing: 'Starting at Rs. 2,80,000',
    description: 'Replicating the timeless stone aesthetics of ancient southern temples.',
    colorPalette: ['#e5d5c5', '#b8860b', '#228b22'],
    features: ['Teakwood Replica Sculpted Pillars', 'Traditional Heritage Pavilion Setups'],
    venueSize: 'Traditional Pavilion & Open Lawns',
    gallery: [IMAGES.templeStyleMandap, IMAGES.galleryBackdrop],
  },
  {
    title: 'Engagement Ceremony',
    subtitle: 'Ivory Glow & Silk Accents',
    category: 'Engagement Ceremony',
    style: 'Elegant',
    image: IMAGES.galleryBackdrop,
    decorCount: '70+ Decor Elements',
    venueType: 'Luxury Hotel Terraces & Boutiques',
    pricing: 'Starting at Rs. 1,50,000',
    description:
      'A harmonious fusion of modern minimalist glass framing with traditional heavy silk ring tray setups.',
    colorPalette: ['#ffffff', '#eec900', '#dcdcdc'],
    features: ['Floating Crystal Illumination Halos', 'Custom Engraved Antique Shagun Plinths'],
    venueSize: 'Luxury Hotel Terraces & Boutiques',
    gallery: [IMAGES.galleryBackdrop, IMAGES.galleryHampers],
  },
  {
    title: 'Reception Decoration',
    subtitle: 'Modern Luxury & Floating Gold Accents',
    category: 'Reception Decoration',
    style: 'Modern',
    image: IMAGES.modernReceptionLounge,
    decorCount: '110+ Decor Elements',
    venueType: 'Grand Ballroom & Glasshouse Pavilions',
    pricing: 'Starting at Rs. 4,000,000',
    description: 'An ultra-chic evening setup starring metallic brass arches.',
    colorPalette: ['#1a1a1a', '#d4af37', '#fdfbf7'],
    features: ['Illuminated Brass Monogram Stage Screens', 'Suspended Filament Glow Canopies'],
    venueSize: 'Grand Ballroom & Glasshouse Pavilions',
    gallery: [IMAGES.modernReceptionLounge, IMAGES.luxuryRoyalWedding],
  },
  {
    title: 'Traditional Pooja Setup',
    subtitle: 'Vibrant Yellows & Traditional Urli Setups',
    category: 'Traditional Pooja Setup',
    style: 'Traditional',
    image: IMAGES.haldiVibrantSetup,
    decorCount: '60+ Decor Elements',
    venueType: 'Courtyards & Heritage Open Terraces',
    pricing: 'Starting at Rs. 95,000',
    description: 'Drenched in auspicious yellows and warm saffron hues.',
    colorPalette: ['#ffcc00', '#ff6600', '#ffffff'],
    features: ['Solid Hammered Brass Shagun Urli Seat', 'Silk Tassel Chandelier Frames'],
    venueSize: 'Courtyards & Heritage Open Terraces',
    gallery: [IMAGES.haldiVibrantSetup, IMAGES.galleryMetalPots],
  },
];
...
const galleryInspirations = [
  {
    ...
    height: 'aspect-[3/4]',
    colorPalette: ['#f5f0eb', '#d4af37', '#8b0000'],
    tags: ['Gold', 'Velvet', 'Mandap', 'Grand'],
    description:
      'A majestic handcrafted mandap arch featuring intricate zardozi embroidery and gold leaf details.',
  },
  {
    ...
    height: 'aspect-[4/5]',
    colorPalette: ['#ffcc00', '#ff6600', '#ffffff'],
    tags: ['Yellow', 'Orange', 'Botanical', 'Haldi'],
  ...
  },
  {
    ...
    image: IMAGES.galleryPlatePacking,
    height: 'aspect-square',
    colorPalette: ['#ffffff', '#eec900', '#dcdcdc'],
    tags: ['Relief', 'White', 'Modern', 'Table'],
    description: 'Elegant minimal tablescapes featuring floating relief patterns.',
  },
];

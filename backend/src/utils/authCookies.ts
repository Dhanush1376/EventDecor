...
export const CUSTOMER_REFRESH_COOKIE = 'siri_refresh_token';
export const ADMIN_REFRESH_COOKIE = 'siri_admin_refresh_token';
...
export const getRefreshCookieOptions = (): CookieOptions => {
  ...
  return {
    ...
    path: '/api',
    maxAge: AuthService.getRefreshTokenTtlMs(),
  };
};
